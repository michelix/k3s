...
master2=172.16.200.62
master3=172.16.200.63
worker1=172.16.200.71
worker2=172.16.200.72
...
lbrange=172.16.200.210-172.16.200.230
...
curl -sO https://raw.githubusercontent.com/michelix/k3s/main/kube-vip.yaml
cat kube-vip.yaml | sed 's/$interface/'$interface'/g; s/$vip/'$vip'/g' > $HOME/kube-vip.yaml
...
curl -sO https://raw.githubusercontent.com/michelix/k3s/main/ip-addr.yaml
cat ip-addr.yaml | sed 's/$lbrange/'$lbrange'/g' > $HOME/ip-addr.yaml
